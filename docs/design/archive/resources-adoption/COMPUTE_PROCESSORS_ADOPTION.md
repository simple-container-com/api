...
export DATABASE_URL="postgresql://<sc-user>:<password>@<host>:5432/app_db"
...
export DATABASE_URL="postgresql://<acme-app>:<password>@<host>:5432/acme_production?sslmode=require"
...
export DATABASE_URL="postgresql://<sc-analytics-user>:<password>@<host>:5432/analytics?sslmode=require"
...
export MONGODB_URI="mongodb+srv://<acme-user>:<password>@<production-cluster>.example.com/<acme-db>?retryWrites=true&w=majority"
...
DATABASE_URL="postgresql://<acme-app>:<prod-pass>@<host>:5432/acme_production"
MONGO_URL="mongodb+srv://<acme-user>:<password>@<prod-cluster>.example.com/<acme-db>"
REDIS_URL="redis://:redis_auth@10.1.0.6:6379"
ANALYTICS_DB="postgresql://<sc-analytics>:<auto-gen-pass>@<host>:5432/analytics"
