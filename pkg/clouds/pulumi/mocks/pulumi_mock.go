...
func (_m *PulumiMock) DestroyChildStack(ctx context.Context, cfg *api.ConfigFile, stack api.Stack, params api.DestroyParams, preview bool) error {
	ret := _m.Called(ctx, cfg, stack, params, preview)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *api.ConfigFile, api.Stack, api.DestroyParams, bool) error); ok {
		r0 = rf(ctx, cfg, stack, params, preview)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *PulumiMock) DestroyParentStack(ctx context.Context, cfg *api.ConfigFile, parentStack api.Stack, params api.DestroyParams, preview bool) error {
	ret := _m.Called(ctx, cfg, parentStack, params, preview)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *api.ConfigFile, api.Stack, api.DestroyParams, bool) error); ok {
		r0 = rf(ctx, cfg, parentStack, params, preview)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *PulumiMock) OutputsStack(ctx context.Context, cfg *api.ConfigFile, stack api.Stack, params api.StackParams) (*api.OutputsResult, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *api.ConfigFile, api.Stack, api.StackParams) (*api.OutputsResult, error)); ok {
		return rf(ctx, cfg, stack, params)
	}
...
func (_m *PulumiMock) PreviewStack(ctx context.Context, cfg *api.ConfigFile, parentStack api.Stack, params api.ProvisionParams) (*api.PreviewResult, error) {
	...
	var r0 *api.PreviewResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *api.ConfigFile, api.Stack, api.ProvisionParams) (*api.PreviewResult, error)); ok {
		return rf(ctx, cfg, parentStack, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *api.ConfigFile, api.Stack, api.ProvisionParams) *api.PreviewResult); ok {
		r0 = rf(ctx, cfg, parentStack, params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*api.PreviewResult)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *api.ConfigFile, api.Stack, api.ProvisionParams) error); ok {
		r1 = rf(ctx, cfg, parentStack, params)
	} else {
		r1 = ret.Error(1)
	}
