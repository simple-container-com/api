...
func TestServiceAccountNaming_LongNames(t *testing.T) {
	RegisterTestingT(t)
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			accountName := util.SanitizeGCPServiceAccountName(tc.input)
...
func TestServiceAccountNaming_RealWorldExample(t *testing.T) {
	RegisterTestingT(t)
	...
	// Use the utility function
	accountName := util.SanitizeGCPServiceAccountName(problematicName)
