...
func Test_appendUserPasswordToMongoUri(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "mongodb://test-user:test-password@shard-00-00.example.com:27017,shard-00-01.example.com:27017,shard-00-02.example.com:27017/test-db?param1=value1&param2=value2",
		},
		{
			...
			want: "mongodb+srv://test-user:test-password@shard-00-00.example.com:27017,shard-00-01.example.com:27017,shard-00-02.example.com:27017/test-db?param1=value1&param2=value2",
		},
	}
